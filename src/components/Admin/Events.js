...
const columns = [
    { id: 'event', label: 'Event title', minWidth: 100, align: 'center' },
    { id: 'type', label: 'Event type', minWidth: 100, align: 'center' },
    { id: 'location', label: 'Event location', minWidth: 100, align: 'center' },
    { id: 'organizer', label: 'Event organizer', minWidth: 100, align: 'center' },
    { id: 'start', label: 'Event start date', minWidth: 100, align: 'center' },
    { id: 'end', label: 'Event end date', minWidth: 100, align: 'center' },
...
const Events = ({ className, staticContext, ...rest }) => {
        ...
        .map((user) => {
            return (
                <TableRow hover role="checkbox" tabIndex={-1} key={user.uuid} >
                    ...
                    <TableCell align="center">{user.type_info}</TableCell>
