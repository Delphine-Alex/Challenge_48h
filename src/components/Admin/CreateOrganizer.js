...
const CreateOrganizer = ({ className, staticContext, ...rest }) => {
                                    ...
                                    <Paper className={classes.mainTable}>
                                        <form
                                            ...
                                            <TextField
                                                ...
                                                type="text"
                                                name="referent"
                                                placeholder="Enter a referent"
                                                variant="outlined"
                                                fullWidth
                                                InputLabelProps={{ shrink: true }}
                                            // onChange={(e) => setCustomer({ ...customer, referent: e.target.value })}
                                            />
                                            ...
                                            <div className={classes.btnContainer}>
                                                <Button className={classes.button} href='/admin/organizers'>Back</Button>
